 ...
 */
public abstract class XFragmentHelper<T extends Fragment> extends XposedExtendHelper {

    protected XFragmentHelper(XC_LoadPackage.LoadPackageParam lpparam, Class<T> targetClazz) {
        super(lpparam);
